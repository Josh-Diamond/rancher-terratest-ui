...
import { AddPool } from '../components/config/AddPool'
    ...
    return (
        <div className='config-wrapper unselectable'>
            ...
            <div className='config'>
                ...
                {typeDetails === 'add_nodepool' ? <AddPool nodes={nodes} count={count} setCount={setCount} setTypeDetails={setTypeDetails} /> : null}
                {/* Notes */}
